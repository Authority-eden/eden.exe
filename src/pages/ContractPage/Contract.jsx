      ...
      <div className={styles.container}>
        <div className={styles.contract}>
          ...
          <p>
            ...
            <br />
            You understand that:
            <br /> Data gathered during your service may be reviewed for
            training, strategic alignment, or performance calibration; This
            process is automatic, non-intrusive, and in full accordance with
            internal transparency principles; No further action is required on
            your part.
          </p>
          <br />
          <br />
          ...
          <p>
            ...
            <br />
            You may not always be notified of observation; Silence, inaction,
            and indecision may also be recorded; This is standard protocol for
            all agents of your clearance level.
          </p>
          <br />
          <br />
          ...
          <p>
            ...
            By continuing:
            <br />
            You reaffirm your voluntary participation in this job; You accept
            that your actions will have lasting ramifications within and beyond
            the assignment and that your choices may affect progression and
            assessment; You understand that all protocols are designed with your
            best performance in mind; Order begins where questions end.
            <br />
